...
<html>
      ...
      <script type="text/javascript">
        $(document).ready(function(){
            ...
            function countdown(){
                ...
                $('#box').html("Renta de utos Level Up! Uruguay. &nbsp;<h3>" + number + "</h3>&nbsp;seg .");
                number--;
                   if(number<0){
                window.location=url;
                       number=0;
  ...
  <body class="thankyou">
    <div id="stage" class="form-all"><p style="text-align:center;"><img src="https://cdn.jotfor.ms/img/check-icon.png" alt="" width="128" height="128" /></p><div style="text-align:center;"><h1 style="text-align: center;">Gracias!</h1><p style="text-align: center;">Hemos recibido su mensaje, le responderé a la brevedad posible. <div id="box"></div>
        </p></div></div>
  </body>
  <script type="text/javascript">
